...
- **Pi 4 working:** After [this commit](https://github.com/Botspot/bvm/commit/d0b0a1ff228bbebfc2250b97255048032f3df3c7), for hardware that lacks A76 CPU cores, such as the Raspberry Pi 4 and other SBCs, Windows 11 version 22621.5624 will be downloaded instead of the most recent public release. This is because the latest Windows 11 requires some extra CPU instructions.
